...
public class UtilsDate {
    ...
    public static void getTimeBetween(Date date, Context context, TextView textView1, TextView textView2) {
        String xingqi;
        JLog.i("时间差:====" + DateUtils.subtractDate(new Date(), date) + "");
        long between = (DateUtils.subtractDate(new Date(), date)) / 1000;//除以1000是为了转换成秒
        long day1 = between / (24 * 3600);
        long hour1 = between % (24 * 3600) / 3600;
        long minute1 = between % 3600 / 60;
        long second1 = between % 60 / 60;
        JLog.i("" + day1 + "天" + hour1 + "小时" + minute1 + "分" + second1 + "秒");
        if (day1 < 0) {
    ...
    public static void getTimeBetween2(Date date1, Date date2, Context context, TextView textView1, TextView textView2, TextView textView3) {
        String xingqi;
        JLog.i("时间差:====" + DateUtils.subtractDate(date1, date2) + "");
        ...
        if (day1 < 0) {
            ...
            JLog.i(day1 + "//////////////");
            JLog.i(DateUtils.formatDateCustom(date2, "MM-dd"));
            JLog.i(xingqi + " " + DateUtils.formatDateCustom(date2, "HH:mm"));
        }
    ...
    public static String get_DAY_OF_WEEK(Date date) {
        ...
        Calendar cal = Calendar.getInstance();
        cal.setTime(date);
        JLog.i("一周中的第" + cal.get(Calendar.DAY_OF_WEEK) + "天");
