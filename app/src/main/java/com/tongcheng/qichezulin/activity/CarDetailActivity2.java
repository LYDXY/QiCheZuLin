...
@ContentView(R.layout.activity_car_detail2)
public class CarDetailActivity2 extends PuTongActivity {
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.tv_second:
                JLog.w("租车界面");
                UtilsTiaoZhuang.ToAnotherActivity(CarDetailActivity2.this, ZuCheActivity2.class);
                break;
