...
@ContentView(R.layout.activity_wang_dian_search2)
public class WangDianSearchActivity2 extends Activity implements View.OnClickListener {


    static BannerShop shop2; //用来回传到上一个界面
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.tv_first:
                UtilsTiaoZhuang.ToAnotherActivity(WangDianSearchActivity2.this, SearchActivity.class);
                break;
            case R.id.iv_return:
                onBackPressed();
                break;
