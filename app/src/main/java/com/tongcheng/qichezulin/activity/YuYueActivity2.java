...
public class YuYueActivity2 extends PuTongActivity2 {
            ...
            case R.id.iv_next_stats: //下一步
                ...
                if (bilizhi != null && !bilizhi.equals("")) {
                    ...
                    if (floats.size() > 0) {
                        ...
                        UtilsTiaoZhuang.ToAnotherActivity(YuYueActivity2.this, OrderDetailActivity.class, bundle);
                    }
                } else {
                    JLog.w("数据有误");
                }
                ...
                try {
                    ...
                    if (!base.status.toString().trim().equals("0")) {
                        if (base.data != null) {
                            ...
                            adapter = new Adapter<FuWuModel>(YuYueActivity2.this, R.layout.listview_item_fu_wu) {
                                @Override
